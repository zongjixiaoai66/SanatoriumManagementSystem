    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费项目" prop="feiyongxinxiName">
                       <el-input v-model="ruleForm.feiyongxinxiName"
                                 placeholder="缴费项目" clearable  :readonly="ro.feiyongxinxiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="缴费项目" prop="feiyongxinxiName">
                           <el-input v-model="ruleForm.feiyongxinxiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="缴费类型" prop="feiyongxinxiTypes">
                        <el-select v-model="ruleForm.feiyongxinxiTypes" :disabled="ro.feiyongxinxiTypes" placeholder="请选择缴费类型">
                            <el-option
                                v-for="(item,index) in feiyongxinxiTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="缴费类型" prop="feiyongxinxiValue">
                        <el-input v-model="ruleForm.feiyongxinxiValue"
                            placeholder="缴费类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费金额" prop="feiyongxinxiNewMoney">
                       <el-input v-model="ruleForm.feiyongxinxiNewMoney"
                                 placeholder="缴费金额" clearable  :readonly="ro.feiyongxinxiNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="缴费金额" prop="feiyongxinxiNewMoney">
                           <el-input v-model="ruleForm.feiyongxinxiNewMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="缴费详情" prop="feiyongxinxiText">
                        <el-input type="textarea"  :readonly="ro.feiyongxinxiText" v-model="ruleForm.feiyongxinxiText" placeholder="缴费详情"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.feiyongxinxiText" label="缴费详情" prop="feiyongxinxiText">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    feiyongxinxiName: false,
                    feiyongxinxiTypes: false,
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=feiyongxinxi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.feiyongxinxiTypesOptions = data.data.list;
                    }
                });
