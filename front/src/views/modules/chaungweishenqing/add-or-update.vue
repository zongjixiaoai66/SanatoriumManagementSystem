        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='chuangwei'">
                    <el-form-item class="select" v-if="type!='info'"  label="床位信息" prop="chuangweiId">
                        <el-select v-model="ruleForm.chuangweiId" :disabled="ro.chuangweiId" filterable placeholder="请选择床位信息" @change="chuangweiChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='chuangwei' ">
                    <el-form-item class="input" v-if="type!='info'"  label="床位状态" prop="chuangweiValue">
                        <el-input v-model="chuangweiForm.chuangweiValue"
                                  placeholder="床位状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chaungweishenqingYesnoTypes" label="申请状态" prop="chaungweishenqingYesnoTypes">
                        <el-input v-model="ruleForm.chaungweishenqingYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chaungweishenqingYesnoText" label="申请结果" prop="chaungweishenqingYesnoText">
                        <span v-html="ruleForm.chaungweishenqingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    chuangweiId: false,
                    yonghuId: false,
                    chaungweishenqingYesnoTypes: false,
                    chaungweishenqingYesnoText: false,
                    updateTime: false,
                },
                ruleForm: {
                    chuangweiId: '',
                    yonghuId: '',
                    chaungweishenqingYesnoTypes: '',
                    chaungweishenqingYesnoText: '',
                    updateTime: '',
                },
                chaungweishenqingYesnoTypesOptions : [],
                chuangweiOptions : [],
                yonghuOptions : [],
                rules: {
                   chuangweiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chaungweishenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chaungweishenqingYesnoTypesOptions = data.data.list;
                    }
                });

         this.$http({
             url: `chuangwei/page?page=1&limit=100&chuangweiTypes=1`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chaungweishenqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chaungweishenqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
