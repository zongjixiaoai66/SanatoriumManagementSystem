    ...
    */
    ...
    public R save(@RequestBody XueshengqingjiaEntity xueshengqingjia, HttpServletRequest request){
        ...
        Wrapper<XueshengqingjiaEntity> queryWrapper = new EntityWrapper<XueshengqingjiaEntity>()
            ...
            .eq("qingjia_types", xueshengqingjia.getQingjiaTypes())
...
//            xueshengqingjia.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R shenhe(@RequestBody XueshengqingjiaEntity xueshengqingjia, HttpServletRequest request){
        logger.debug("shenhe方法:,,Controller:{},,xueshengqingjia:{}",this.getClass().getName(),xueshengqingjia.toString());

//        if(xueshengqingjia.getXueshengqingjiaYesnoTypes() == 2){//通过
//            xueshengqingjia.setXueshengqingjiaTypes();
//        }else if(xueshengqingjia.getXueshengqingjiaYesnoTypes() == 3){//拒绝
//            xueshengqingjia.setXueshengqingjiaTypes();
//        }
        xueshengqingjiaService.updateById(xueshengqingjia);//审核
        return R.ok();
    }
...
//                            xueshengqingjiaEntity.setQingjiaTypes(Integer.valueOf(data.get(0)));   //请假类型 要改的
...
//                            xueshengqingjiaEntity.setYonghuId(Integer.valueOf(data.get(0)));   //患者 要改的
