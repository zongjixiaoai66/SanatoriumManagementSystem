...
//            feiyongxinxi.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<FeiyongxinxiEntity> feiyongxinxiList = new ArrayList<>();//上传的东西
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            FeiyongxinxiEntity feiyongxinxiEntity = new FeiyongxinxiEntity();
//                            feiyongxinxiEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            feiyongxinxiEntity.setFeiyongxinxiName(data.get(0));                    //缴费项目 要改的
//                            feiyongxinxiEntity.setFeiyongxinxiTypes(Integer.valueOf(data.get(0)));   //缴费类型 要改的
//                            feiyongxinxiEntity.setFeiyongxinxiNewMoney(data.get(0));                    //缴费金额 要改的
//                            feiyongxinxiEntity.setFeiyongxinxiText(data.get(0));                    //缴费详情 要改的
//                            feiyongxinxiEntity.setCreateTime(date);//时间
                            feiyongxinxiList.add(feiyongxinxiEntity);
                        ...
                        //查询是否重复
                        feiyongxinxiService.insertBatch(feiyongxinxiList);
                        return R.ok();
                    }
                }
            }
