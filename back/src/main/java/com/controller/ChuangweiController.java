...
//                            chuangweiEntity.setChuangweiName(data.get(0));                    //床位编号 要改的
//                            chuangweiEntity.setChuangweiAddress(data.get(0));                    //房间地址 要改的
//                            chuangweiEntity.setChuangweiTypes(Integer.valueOf(data.get(0)));   //床位状态 要改的
